...
export const suBirNetEslesmeleri: SuBirNetEslesme[] = [
  ...
  { birnetFonksiyon: "Abone Kapama / Açma", workspace: "abone", uxTipi: "ACTION", konum: "İşlemler → Kapama", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Abone Devir / Nakil", workspace: "abone", uxTipi: "ACTION", konum: "İşlemler → Devir", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Abone No Değiştirme", workspace: "abone", uxTipi: "ACTION", konum: "İşlemler → No Değiştir", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Sayaç Bağlama / Tesis Katkı Payı", workspace: "abone", uxTipi: "ACTION", konum: "İşlemler → Sayaç Bağlama", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Abone Hesap Dökümü", workspace: "abone", uxTipi: "REPORT", konum: "İşlemler → Hesap Dökümü", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Abone Borç Dökümü", workspace: "abone", uxTipi: "REPORT", konum: "İşlemler → Borç Dökümü", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Abone Genel Borç Özeti", workspace: "abone", uxTipi: "REPORT", konum: "Detay → Borç & Bakiye", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Abone Hesap Düzeltme", workspace: "duzeltme", uxTipi: "TAB", konum: "Düzeltme türü", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Hesap Düzeltme Listesi", workspace: "duzeltme", uxTipi: "DETAIL", konum: "Kayıt geçmişi", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Borç Listesi", workspace: "abone", uxTipi: "DETAIL", konum: "Detay → Borç & Bakiye", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Bakiye Listesi", workspace: "abone", uxTipi: "DETAIL", konum: "Detay → Borç & Bakiye", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Bakiye Kontrol", workspace: "abone", uxTipi: "DETAIL", konum: "Detay → Borç & Bakiye", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Özet Borç Listesi", workspace: "abone", uxTipi: "DETAIL", konum: "Detay → Borç & Bakiye", durum: "TAMAMLANDI" },
  { birnetFonksiyon: "Faturaya Tanker Kullanımı Ekle", workspace: "fatura", uxTipi: "SECTION", konum: "Toplu İşlemler → Tanker", durum: "TAMAMLANDI" },
