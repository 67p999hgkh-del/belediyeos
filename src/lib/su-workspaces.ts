...
export const suBirNetEslesmeleri: SuBirNetEslesme[] = [
  ...
  { birnetFonksiyon: "Faturaya Tanker Kullanımı Ekle", workspace: "fatura", uxTipi: "ACTION", konum: "Toplu İşlemler", durum: "PLANLI" },
  { birnetFonksiyon: "Abone No Değiştirme Listesi", workspace: "abone", uxTipi: "DETAIL", konum: "Detay → Hareketler", durum: "PLANLI" },
  // Fatura — planlı
  { birnetFonksiyon: "Fatura Tahakkuk", workspace: "fatura", uxTipi: "TAB", konum: "Dönem & Tahakkuk", durum: "PLANLI" },
  { birnetFonksiyon: "Toplu Fatura Kesme", workspace: "fatura", uxTipi: "TAB", konum: "Toplu İşlemler", durum: "PLANLI" },
  { birnetFonksiyon: "Tankerle Su Taşıma", workspace: "fatura", uxTipi: "SECTION", konum: "Toplu İşlemler", durum: "PLANLI" },
  // Kredi — doğrulanmış
