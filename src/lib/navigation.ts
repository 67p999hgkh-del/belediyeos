    ...
    items: [
      {
        ...
        children: [
          ...
          { id: "t-makbuz-tekrar", label: "Makbuz Tekrar Yazdırma", href: "/tahsilat/makbuz-tekrar" },
    ...
    items: [
      {
        ...
        icon: Users,
        children: [
          { id: "pm-hub", label: "Memur Hub", href: "/personel/memur" },
          { id: "pm-kart", label: "Personel Kartı", href: "/personel/memur/personel-karti" },
          { id: "pm-maas", label: "Maaş & Bordro", href: "/personel/memur/maas-bordro" },
          { id: "pm-mesai", label: "Ek Mesai", href: "/personel/memur/ek-mesai" },
          { id: "pm-emeklilik", label: "Emeklilik", href: "/personel/memur/emeklilik" },
          { id: "pm-kesinti", label: "Kesinti & Yatırım", href: "/personel/memur/kesinti-yatirim" },
          { id: "pm-cek", label: "Çek İşlemleri", href: "/personel/memur/cek-islemleri" },
          { id: "pm-liste", label: "Personel Listeleri", href: "/personel/memur/listeler" },
          { id: "pm-geri", label: "İşlem Geri Alma", href: "/personel/memur/islem-geri-alma" },
        ],
      },
      {
        id: "personel-isci",
    ...
    items: [
      {
        ...
        children: [
          { id: "sy-kullanici", label: "Kullanıcı Ayarları", href: "/sistem/kullanici-ayarlari" },
